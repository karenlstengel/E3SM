...
./atmchange mac_aero_mic::atm_procs_list= # empty physics for testing?
...
./xmlchange STOP_N='2',STOP_OPTION='nsteps' # note that we need to run this for 10 days to see anything interesting
