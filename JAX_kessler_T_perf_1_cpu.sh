...
export JAX_COMPILATION_CACHE_DIR="/glade/derecho/scratch/kstengel/E3SM/E3SM/components/eamxx/src/physics/kessler/.JAX_T_cache_cpu"
...
CASE_NAME="JAX_T_ne30np4_1nsteps_cpu"
