...
string(APPEND CMAKE_C_FLAGS_DEBUG   " -O0 -g -Wimplicit-float-conversion")
string(APPEND CMAKE_CXX_FLAGS_DEBUG " -O0 -g -Wimplicit-float-conversion")
string(APPEND CMAKE_Fortran_FLAGS_DEBUG   " -O0 -g -Wimplicit-float-conversion -check uninit -check bounds -check pointers -fpe0 -check noarg_temp_created -init=snan,arrays")
