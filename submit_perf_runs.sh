...
qsub -N perf_1_cpu  -A NTDD0004 -j oe -k eod -q develop  -l walltime=00:30:00 -l select=1:ncpus=128:mem=235GB  -M kstengel@ucar.edu -m e kessler_perf_1_cpu.sh
...
qsub -N perf_5_cpu  -A NTDD0004 -j oe -k eod -q develop  -l walltime=00:30:00 -l select=1:ncpus=128:mem=235GB  -M kstengel@ucar.edu -m e kessler_perf_5_cpu.sh
...
qsub -N perf_5_gpuOA  -A NTDD0004 -j oe -k eod -q develop  -l walltime=00:30:00 -l select=1:ncpus=64:mem=480GB:ngpus=4:gpu_type=a100  -M kstengel@ucar.edu -m e kessler_perf_5_gpuOA.sh


# bigger runs for checking errors
qsub -N perf_10_cpu  -A NTDD0004 -j oe -k eod -q develop  -l walltime=00:30:00 -l select=1:ncpus=128:mem=235GB  -M kstengel@ucar.edu -m e kessler_perf_10_cpu.sh
