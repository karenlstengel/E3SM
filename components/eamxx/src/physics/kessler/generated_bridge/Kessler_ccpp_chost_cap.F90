...
contains
  ...
  subroutine Kessler_chost_physics_initialize(lv, pref, rhoqr, gravit, errmsg, errflg) &
    ...
    errmsg_f = ' '
    errflg = 0
    call kessler_suite_suite_initialize( &
  ...
  subroutine Kessler_chost_physics_timestep_initial( &
    ...
    errmsg_f = ' '
    errflg = 0
    call kessler_suite_suite_timestep_initial( &
  ...
  subroutine Kessler_chost_physics_timestep_final( &
    ...
    errmsg_f = ' '
    errflg = 0
    call kessler_suite_suite_timestep_final( &
  ...
  subroutine Kessler_chost_physics_run( &
      ncol, nz, col_start, col_end, dt, lyr_surf, lyr_toa, cpair, rair, rho, z_mid,  &
      exner, theta, qv, qc, qr, precl, relhum, temp_prev, temp_tend, scheme_name,  &
      errmsg, errflg) &
    ...
    call kessler_suite_suite_physics( &
        col_start, col_end, nz, real(dt, kind_phys), lyr_surf, lyr_toa,  &
        cpair, rair, rho, z_mid, exner, theta, qv, qc, qr, precl, relhum,  &
        temp_prev, temp_tend, scheme_name_f, errmsg_f, errflg)
